function show(btn, classifier, name) {
  ...
  for (var i = 0; i < tabs.length; i++) {
    tabs[i].classList.remove("w3-blue");
    tabs[i].classList.add("w3-green");
  }
  // colour this button
...
function showAlert() {
  var myText =
    "Congratulations! Your booking is confirmed. Please check your email for the confirmation reciept";
  alert(myText);
}
